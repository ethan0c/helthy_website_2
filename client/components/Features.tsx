          ...
          <div className="flex-1 flex flex-col gap-24">
            <div className="flex flex-col gap-9">
              ...
              <p className="text-white text-xl leading-[130%] max-w-[552px]">
                No two bodies are the same and neither are our workouts. Helthy
                builds custom fitness programs that adapt to your goals, body
                type, and schedule. Whether you're burning fat, building muscle,
                or just starting your fitness journey, every plan is guided by
                real science and designed for lasting results.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-8 opacity-30">
              ...
              <p className="text-white text-xl leading-[130%] max-w-[552px]">
                Healthy living starts in the kitchen. Helthy helps you eat
                smarter with meal plans that match your fitness goals and
                lifestyle — whether that's losing weight, gaining strength, or
                maintaining balance.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-8 opacity-30">
              ...
              <p className="text-white text-xl leading-[130%] max-w-[552px]">
                See your transformation in real time. Helthy's smart dashboard
                tracks every workout, meal, and milestone helping you visualize
                your journey and stay motivated. Watch your performance improve,
                monitor your weight and measurements, and celebrate every step
                of your progress. Because when you can see the change, you
                believe in it even more
              </p>
            </div>
          </div>
